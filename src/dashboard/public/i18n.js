...
(function() {
  const translations = {
    en: {
      ...
      creator_name: 'Elaina',
      creator_detail: 'Built with Node.js, Discord.js, and VanillaDB. Designed to be fast, reliable, and beautiful.',
    ...
    vi: {
      ...
      creator_name: 'Elaina',
      creator_detail: 'Xây dựng bằng Node.js, Discord.js và VanillaDB. Được thiết kế nhanh, đáng tin cậy và đẹp mắt.',
